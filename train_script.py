...
MODELS_DIR = "/home/ben.gelman/private_models/"
DATA_DIR = "/home/ben.gelman/private_datasets/"
...
for ALPHA in ALPHAS:
    ...
    for EPSILON in EPSILONS:
        ...
        # adjust data destination and source model locations based on epsilong and alpha parameter values
        task = "val"
        if (ALPHA is not None) and (EPSILON is not None):
            model_dir = f"/home/ben.gelman/private_models/{DATASET_NAME}_{METHOD}_dp_{ALPHA}a_{EPSILON}e/train/"
            data_dir = f"/home/ben.gelman/private_datasets/{DATASET_NAME}_{METHOD}_dp_{ALPHA}a_{EPSILON}e/{task}/"
        else:
            model_dir = f"/home/ben.gelman/private_models/{DATASET_NAME}_{METHOD}/train/"
            data_dir = f"/home/ben.gelman/private_datasets/{DATASET_NAME}_{METHOD}/{task}/"
